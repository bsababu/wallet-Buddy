    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div>
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <h2 className="mt-10 text-center text-2xl font-bold leading-3 tracking-tight text-white-600">Sign in to your account</h2>
        </div>
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" action="#" method="POST">
            ...
            <div>
              <Link href="/dashboard">
                <button className="btn btn-outline w-full max-w-xs">Sign in</button></Link>
            </div>
          </form>
        </div>
      </div>
