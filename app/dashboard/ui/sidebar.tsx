...
const Siderbar = () => {
  return (
    <div className="flex flex-col items-center w-40 text-gray-600 bg-gray-900 h-screen" >
                <div className="px-4">
                    <div className="flex flex-col items-center w-full mt-3 md-5 border-t border-gray-700">
                        ...
                        <a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
                            ...
                            <span className="ml-2 text-sm font-medium">Saving</span>
                        </a>
                        <a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
                            <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
